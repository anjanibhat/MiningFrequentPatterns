...
public class PackageInitializer {
	...
	public static void main (String[] args) {
		...
		HashMap<Integer, List<String>> databse = createDatabase(path);
		databse = sortOnFrequncy(databse);
		
		createFPTree(databse);
		HashMap<String, List<List<TreeNode>>> conditionalFPTree = createConditionalFPtree();
		HashMap<String, List<Pair>> conditionalPatternBase = generateConditionalPatternBase(conditionalFPTree);
		generateAllFrequentItemSets(conditionalPatternBase);
	}
}
